...
from cfg import CONFIG_PATH, ABLATION_FEATURES_PRED, ABLATION_FEATURES_EVAL
...
if __name__ == "__main__":
    ...
    eval_path = ABLATION_FEATURES_EVAL
    ...
    for task in config["tasks"]:
        ...
        for dataset in task['datasets']:
            ...
            meta_result_folder = ABLATION_FEATURES_PRED
            ...
            for meta_result_path in meta_result_folder.glob(f"*{dataset['dataset_id']}---*.csv"):
                ...
                ranks_df.describe().to_csv(ABLATION_FEATURES_EVAL / f"describe_rank#{output_name}.csv")
                ...
                stacked_barchart(rank_percentages, out_path = ABLATION_FEATURES_EVAL / f"rank_count_{output_name}.png")
                ...
                reshaped_metrics.to_csv(ABLATION_FEATURES_EVAL / f"reshaped_metrics#{output_name}.csv", index=False)
                ...
                wilcoxon_results.to_csv(ABLATION_FEATURES_EVAL / f"wilcoxon_posthoc#{output_name}.csv")
                ...
                error_distribution_with_wilcoxon(
                    ...
                    out_path = ABLATION_FEATURES_EVAL / f"combined_plot#{output_name}.png"
                )